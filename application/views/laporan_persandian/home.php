                   ...
                   <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            ?>
                               <a target="_blank" href="<?= base_url('assets')?>/pdf_files/evaluasi_persandian/<?= $value->Dokumen_Eval?>"><img src="<?= base_url('assets')?>/img/PDF_icon.png" width="20%"><br><?= $value->Dokumen_Eval ?></a>
                            <?php
                                }
                            ?>                            
                        </div>
